<div class="widget">
    <rd-widget-header>
        <div class="widget-header ng-binding">
            <i class="fa fa-users" data-translate="userManagement.home.title">Users</i>
        </div>
    </rd-widget-header>
</div>
<jhi-alert></jhi-alert>
    ...
    <table class="jh-table table table-striped">
        ...
        <tbody>
            <tr ng-repeat="user in vm.users track by user.id">
                ...
                <td>{{user.email}}</td>
                <td>
                    <button class="btn btn-danger btn-xs" ng-click="vm.setActive(user, true)" ng-show="!user.activated" data-translate="userManagement.deactivated">Deactivated</button>
                    <button class="btn btn-success btn-xs" ng-click="vm.setActive(user, false)" ng-show="user.activated" ng-disabled="vm.currentAccount.login === user.login"
                        data-translate="userManagement.activated">Activated</button>
                </td>
                <td>{{user.langKey}}</td>
                <td>
                ...
                <td class="text-right">
                    <div class="btn-group flex-btn-group-container">
                        ...
                        <button type="submit" ui-sref="user-management.delete({login:user.login})" class="btn btn-danger btn-sm" ng-disabled="vm.currentAccount.login === user.login">
