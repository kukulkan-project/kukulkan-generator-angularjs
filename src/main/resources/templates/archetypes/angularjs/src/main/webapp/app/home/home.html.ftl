<div ng-cloak>
    <div class="row">
        <div class="col-md-12 widget">
            ...
            <ul>
                <li>
                    <a href="https://github.com/${project.id}-project" target="_blank" rel="noopener" data-translate="home.link.homepage">${project.id?cap_first} homepage</a>
                </li>
                <li>
                    <a href="https://github.com/${project.id}-project" target="_blank" rel="noopener" data-translate="home.link.stackoverflow">${project.id?cap_first} on Stack Overflow</a>
                </li>
                <li>
                    <a href="https://github.com/${project.id}-project/${project.id}-engine/issues" target="_blank" rel="noopener" data-translate="home.link.bugtracker">${project.id?cap_first} bug tracker</a>
                </li>
                <li>
                    <a href="https://github.com/${project.id}-project" target="_blank" rel="noopener" data-translate="home.link.chat">${project.id?cap_first} public chat room</a>
                </li>
                <li>
            ...
            <p>
                <span data-translate="home.like">If you like ${project.id?cap_first}, don't forget to give us a star on </span>&nbsp;
