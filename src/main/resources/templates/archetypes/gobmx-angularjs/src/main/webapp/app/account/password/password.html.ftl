<div class="container-fluid">
    <h2 data-translate="password.title" translate-values="{username: '{{vm.account.login}}'}">Password for [<b>{{vm.account.login}}</b>]
    </h2>
    <hr class="black"/>
    ...
    <form name="form" role="form" novalidate ng-submit="vm.changePassword()" show-validation>
        ...
        <div class="form-group">
            <label class="control-label" for="confirmPassword" data-translate="global.form.confirmpassword">New password
                confirmation</label>
        ...
        <div class="pull-right">
            <button type="submit" ng-disabled="form.$invalid" class="btn btn-primary" data-translate="password.form.button">
                Save
            </button>
        </div>
    </form>
