package ${project.packaging}.web.rest;

import ${project.packaging}.config.Constants;
import ${project.packaging}.${project.id?cap_first}App;
import ${project.packaging}.domain.Authority;
import ${project.packaging}.domain.User;
import ${project.packaging}.repository.AuthorityRepository;
import ${project.packaging}.repository.UserRepository;
import ${project.packaging}.security.AuthoritiesConstants;
import ${project.packaging}.service.MailService;
import ${project.packaging}.service.dto.UserDTO;
import ${project.packaging}.web.rest.errors.ExceptionTranslator;
import ${project.packaging}.web.rest.vm.KeyAndPasswordVM;
import ${project.packaging}.web.rest.vm.ManagedUserVM;
import ${project.packaging}.service.UserService;
...
@SpringBootTest(classes = ${project.id?cap_first}App.class)
