package ${project.packaging}.repository;

import ${project.packaging}.${project.id?cap_first}App;
import ${project.packaging}.config.Constants;
import ${project.packaging}.config.audit.AuditEventConverter;
import ${project.packaging}.domain.PersistentAuditEvent;
...
import static ${project.packaging}.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
