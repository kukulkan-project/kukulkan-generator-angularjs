				...
				<div class="form-group">
	                <div class="form-group datepicker-group">
	                    ...
	                    <input id="${property.name}" class="form-control" placeholder="aaaa-mm-dd" maxlength="10"
	                           name="start" ng-model="vm.${entity.name}.${property.name}" ng-change="vm.onChangeDate()" ng-click="vm.onChangeDate()" required>
