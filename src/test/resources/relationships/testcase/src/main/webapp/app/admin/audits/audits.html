<div class="widget">
    <rd-widget-header>
        <div class="widget-header ng-binding">
            <i class="fas fa-edit" data-translate="audits.title">Audits</i>
        </div>
    </rd-widget-header>
</div>
<div class="row">
    ...
    <thead>
        <tr>
            <th ng-click="predicate = 'timestamp'; reverse=!reverse">
                <span data-translate="audits.table.header.date">Date</span>
            </th>
            <th ng-click="predicate = 'principal'; reverse=!reverse">
                <span data-translate="audits.table.header.principal">User</span>
            </th>
            <th ng-click="predicate = 'type'; reverse=!reverse">
                <span data-translate="audits.table.header.status">State</span>
            </th>
            <th ng-click="predicate = 'data.message'; reverse=!reverse">
                <span data-translate="audits.table.header.data">Extra data</span>
            </th>
        </tr>
    </thead>
    ...
    <tr ng-repeat="audit in vm.audits | filter:filter | orderBy:predicate:reverse" ng-hide="audit.filtered">
        ...
        <td>
            ...
            <span ng-show="audit.data.remoteAddress">
                <span data-translate="audits.table.data.remoteAddress">Remote Address</span> {{audit.data.remoteAddress}}</span>
        </td>
    </tr>
</table>
